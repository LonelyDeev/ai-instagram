...
$(".buy_now").on("click", function(e) {
  ...
  if (payment_type == "banktransfer") {
    ...
    $(".data-bank-name").html(
      $("input[name=paymentmode]:checked").attr("data-bank-name")
    );
    $(".data-account-holder-name").html(
      $("input[name=paymentmode]:checked").attr("data-account-holder-name")
    );
    $(".data-account-number").html(
      $("input[name=paymentmode]:checked").attr("data-account-number")
    );
    $(".data-bank-ifsc-code").html(
      $("input[name=paymentmode]:checked").attr("data-bank-ifsc-code")
    );
  ...
  if (payment_type == "mercadopago") {
    ...
    $.ajax({
      ...
      data: {
        ...
        payment_type: payment_type,
        payment_id: "",
        successurl: buyurl + "/mercadorequest/success",
