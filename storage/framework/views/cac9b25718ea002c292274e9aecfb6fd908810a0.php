<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <?php endif; ?>
        <h4 class="new-user-no-content">
            👋🏻 <span class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?>"><?php echo e(Auth::user()->name); ?></span><span class="text-muted"> — </span><span
                class="text-muted"><?php echo e(trans('labels.web_trafic_desc')); ?></span>
        </h4>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/index.blade.php ENDPATH**/ ?>