    ...
    <div class="row">
        ...
        <div class="<?php if(request()->route('slug') != 'artical-generator-pro'): ?> col-lg-4 col-md-12 <?php else: ?>  col-lg-12 col-md-12 <?php endif; ?>">
            <form class="card border-0 shadow p-3 h-100">
                ...
                <?php endif; ?>
                <?php if(request()->route('slug') != 'long-form' && request()->route('slug') != 'factual-answer' && request()->route('slug') != 'interview-questions' && request()->route('slug') != 'ai-images' && request()->route('slug') != 'artical-generator-pro'): ?>
                <div class="col-12 mt-2">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\aiwriter\resources\views/admin/content.blade.php ENDPATH**/ ?>