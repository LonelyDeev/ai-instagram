                                                ...
                                                <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                                                    <small
                                                        class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?> d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                                         ...
                                                         <span
                                                            class="text-success"><?php echo e(@$data['original']['plan_date']); ?></span></small>
                                                <?php else: ?>
                                                    <small
                                                        class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?> d-block"><?php echo e(@$data['original']['plan_message']); ?>

                                                         <span
                                                            class="text-danger"><?php echo e(@$data['original']['plan_date']); ?></span></small>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <?php if(@$data['original']['plan_date'] > date('Y-m-d')): ?>
                                                <small class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?> d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                                    ...
                                                    <span class="text-success">
                                                        <?php echo e(@$data['original']['plan_date']); ?>
                                            ...
                                            <?php else: ?>
                                                <small class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?> d-block"><?php echo e(@$data['original']['plan_message']); ?>
                                                    ...
                                                    <span class="text-danger"> <?php echo e(@$data['original']['plan_date']); ?></span>
                                                </small>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                            ...
                                            <?php if($data['original']['plan_date'] != ''): ?>
                                                <small class="<?php echo e(session()->get('theme') == "dark" ? 'text-white' : 'text-dark'); ?>">
                                                    <?php echo e(@$data['original']['plan_message']); ?>: <span
                                                        class="text-success"><?php echo e(@$data['original']['plan_date']); ?></span>
                                                </small>
                                            <?php else: ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/plan/plan.blade.php ENDPATH**/ ?>