...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="mobile" value="<?php echo e($user->mobile); ?>" placeholder="mobile" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <img class="rounded-circle mt-2" src="<?php echo e(helper::image_path($user->image)); ?>" alt="" width="70" height="70">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/user/edit_user.blade.php ENDPATH**/ ?>