            ...
            <form class="card border-0 shadow p-3 h-100">
                ...
                <?php elseif(request()->route('slug') == 'artical-generator'): ?>
                    ...
                    <div class="col-12 mt-2">
                        <label for="ai_type" class="form-label"><?php echo e(trans('labels.ai_type')); ?> </label>
                        <select id="ai_type" class="form-select">
                            <option value="normal"><?php echo e(trans('labels.ai_type_normal')); ?></option>
                            <option value="articleai"><?php echo e(trans('labels.ai_type_gpt3_5')); ?></option>
                        </select>
                        <p class=" fs-7 mt-1 text-danger d-none" id="ai_type_gpt3_5_description"><?php echo e(trans('labels.ai_type_gpt3_5_description')); ?></p>
                    </div>
                    <div class="col-12 mt-2">
                ...
                <?php endif; ?>
                <?php if(request()->route('slug') != 'long-form' && request()->route('slug') != 'factual-answer' && request()->route('slug') != 'interview-questions' && request()->route('slug') != 'ai-images'): ?>
                <div class="col-12 mt-2  hide-for-articleai">
                ...
                <?php endif; ?>
                <?php if(request()->route('slug') != 'ai-images'): ?>
                <div class="row hide-for-articleai">
                    <div class="col-6 mt-2">
                        <label for="level" class="form-label"><?php echo e(trans('labels.creativity_level')); ?> </label>
                        <select id="level" class="form-select">
                            <option value="0.7"><?php echo e(trans('labels.optimal')); ?></option>
                            <option value="0"><?php echo e(trans('labels.none_factual')); ?></option>
                            <option value="0.1"><?php echo e(trans('labels.low')); ?></option>
                            <option value="0.6"><?php echo e(trans('labels.medium')); ?></option>
                            <option value="0.9"><?php echo e(trans('labels.high')); ?></option>
                            <option value="1"><?php echo e(trans('labels.max_factual')); ?></option>
                        </select>
                    </div>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/content.blade.php ENDPATH**/ ?>