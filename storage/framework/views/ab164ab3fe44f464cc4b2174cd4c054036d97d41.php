    ...
    <ul class="navbar-nav">
        <?php if(!empty(helper::plandetail(Auth::user()->plan_id)->name)): ?>
            <li class="nav-item fs-7">
                ...
                <div class="d-flex justify-content-between">
                    <strong
                        class="<?php echo e(@helper::wordcount(Auth::user()->id) == 0 ? 'text-danger' : 'text-success'); ?>"><?php echo e(number_format(helper::wordcount(Auth::user()->id))); ?>
        ...
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/index')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('index') ? 'active' : ''); ?>"><i
                    class="fa-solid fa-house-user"></i><span><?php echo e(trans('labels.home')); ?></span></a>
        </li>
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/alltools')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('alltools') ? 'active' : ''); ?>"><i
                    class="fa-solid fa-layer-group"></i><span><?php echo e(trans('labels.all_tools')); ?></span></a>
        </li>
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/content-ai-images')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('ai-images') ? 'active' : ''); ?>"><i
        ...
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/mycontent')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('mycontent*') ? 'active' : ''); ?>"><i
        ...
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/changepassword')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('changepassword') ? 'active' : ''); ?>"><i
                    class="fa-solid fa-lock"></i><span><?php echo e(trans('labels.change_password')); ?></span></a>
        </li>
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/plan')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('plan') ? 'active' : ''); ?>"><i
        ...
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/transactions')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('transactions') ? 'active' : ''); ?>"><i
        ...
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/contactus')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('contactus') ? 'active' : ''); ?>"><i
                    class="fa-solid fa-address-book"></i><span><?php echo e(trans('labels.contact_us')); ?></span></a>
        </li>
        <li class="nav-item fs-7 mb-1">
            <a href="<?php echo e(URL::to('/logout')); ?>"
                class="nav-link d-flex rounded text-black <?php echo e(request()->is('logout') ? 'active' : ''); ?>"><i
                    class="fa-solid fa-right-from-bracket"></i><span><?php echo e(trans('labels.logout')); ?></span></a>
        </li>
    </ul>
<?php endif; ?>
<?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/layout/sidebarcommon.blade.php ENDPATH**/ ?>