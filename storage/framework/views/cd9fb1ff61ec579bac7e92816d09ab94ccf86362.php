                    ...
                    <div class="card tools-card border-0 shadow w-100 h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <img src="<?php echo e(helper::image_path( $tool->id . '.svg')); ?>" class="img-fluid rounded-circle" height="35" width="35" alt="">
...
<?php /**PATH C:\laragon\www\ai-writer-master\resources\views/admin/tools/tools.blade.php ENDPATH**/ ?>