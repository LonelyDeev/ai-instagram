                ...
                <div class="navbarnav">
                    <ul class="d-flex">
                        <li class="nav-item p-4">
                            <a class="nav-link active" href="<?php echo e(URL::to('/')); ?>#home"> Home </a>
                        </li>
                        <li class="nav-item p-4">
                            <a class="nav-link" href="<?php echo e(URL::to('/')); ?>#aboutus">About Us</a>
                        </li>
                        <li class="nav-item p-4">
                            <a class="nav-link" href="<?php echo e(URL::to('/')); ?>#features">Features</a>
                        </li>
                        <li class="nav-item p-4">
                            <a class="nav-link" href="<?php echo e(URL::to('/')); ?>#tools">Tools</a>
                        </li>
                        <li class="nav-item p-4">
                            <a class="nav-link" href="<?php echo e(URL::to('/')); ?>#blogs">Blogs</a>
                        </li>
                        <li class="nav-item p-4">
                            <a class="nav-link" href="<?php echo e(URL::to('/')); ?>#pricing">Pricing Plan</a>
                        </li>
                    </ul>
                </div>
                <div class="login-btn">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <h1 class="text-center"><?php echo e(trans('labels.terms_condition')); ?></h1>
                        <?php if(!empty($gettermscondition)): ?>
                    <div class="cms-section my-3">
                     <?php echo $gettermscondition; ?>
        ...
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-end">
                ...
                <div class="copy-right">
                    ...
                    <a href="privacy-policy"> <?php echo e(trans('labels.privacy_policy')); ?></a> | <a href="termscondition"> <?php echo e(trans('labels.terms_condition')); ?> </a> | <a href="about-us"><?php echo e(trans('labels.about_us')); ?></a>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\market.mrcode.ir-ai-writer-saas-v2.0\aiwriter\resources\views/admin/other/termscondition.blade.php ENDPATH**/ ?>